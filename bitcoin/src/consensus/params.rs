...
/// The dogecoin mainnet parameters.
pub static DOGECOIN: Params = Params::DOGECOIN;
/// The dogecoin testnet parameters.
pub static DOGECOIN_TESTNET: Params = Params::DOGECOIN_TESTNET;
/// The dogecoin regtest parameters.
pub static DOGECOIN_REGTEST: Params = Params::DOGECOIN_REGTEST;
...
impl Params {
    ...
    /// The Dogecoin testnet parameters.
    pub const DOGECOIN_TESTNET: Params = Params {
    ...
    /// The Dogecoin regtest parameters.
    pub const DOGECOIN_REGTEST: Params = Params {
    ...
    pub const fn new(network: Network) -> Self {
        match network {
            ...
            Network::DogecoinTestnet => Params::DOGECOIN_TESTNET,
            Network::DogecoinRegtest => Params::DOGECOIN_REGTEST,
        }
    }
