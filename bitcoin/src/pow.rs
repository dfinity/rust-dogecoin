...
impl Target {
    ...
    /// Not all target values are attainable because consensus code uses the compact format to
    /// represent targets (see [`CompactTarget`]).
    pub const MAX_ATTAINABLE_MAINNET_DOGE: Self = Target(U256(0xFFFF_u128 << (220 - 128), 0));
    ...
    pub const MAX_ATTAINABLE_TESTNET_DOGE: Self = Target(U256(0xFFFF_u128 << (220 - 128), 0));
